...
import 'bs_actualizar_producto_model.dart';
export 'bs_actualizar_producto_model.dart';

class BsActualizarProductoWidget extends StatefulWidget {
  const BsActualizarProductoWidget({
    super.key,
  ...
  @override
  State<BsActualizarProductoWidget> createState() =>
      _BsActualizarProductoWidgetState();
}

class _BsActualizarProductoWidgetState
    extends State<BsActualizarProductoWidget> {
  late BsActualizarProductoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BsActualizarProductoModel());
                  ...
                  onPressed: () async {
                    var confirmDialogResponse = await showDialog<bool>(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: Text(
                                  'Desea actualizar el articulo ${widget.producto?.nombre}? '),
                              actions: [
                                TextButton(
                                  onPressed: () =>
                    ...
                    if (confirmDialogResponse) {
                      await widget.producto!.reference
                        ...
                        precio:
                            int.tryParse(_model.txtPrecioTextController.text),
                      ));
                    }
                    await showDialog(
                      context: context,
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          content: const Text('Se han aplicado los cambios'),
                          actions: [
                            TextButton(
                              onPressed: () =>
