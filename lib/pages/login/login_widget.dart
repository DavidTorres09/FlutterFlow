...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    _model.txtPasswordConfirmTextController ??= TextEditingController();
    _model.txtPasswordConfirmFocusNode ??= FocusNode();

    _model.txtUsuarioTextController ??= TextEditingController();
    _model.txtUsuarioFocusNode ??= FocusNode();

    _model.txtImagenTextController ??= TextEditingController();
    _model.txtImagenFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color(0xFF5E08AF),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: _model.txtPasswordConfirmTextController,
                          focusNode: _model.txtPasswordConfirmFocusNode,
                          autofocus: true,
                          obscureText: !_model.txtPasswordConfirmVisibility,
                          decoration: InputDecoration(
                            ...
                            suffixIcon: InkWell(
                              onTap: () => setState(
                                () => _model.txtPasswordConfirmVisibility =
                                    !_model.txtPasswordConfirmVisibility,
                              ),
                              focusNode: FocusNode(skipTraversal: true),
                              child: Icon(
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: _model.txtImagenTextController,
                          focusNode: _model.txtImagenFocusNode,
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Imagen',
                          ...
                          validator: _model.txtImagenTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ],
                      ...
                      children: [
                        FlutterFlowDropDown<String>(
                          controller: _model.dDRolValueController ??=
                            ...
                            _model.dDRolValue ??= 'Cliente',
                          ),
                          options: List<String>.from(
                              ['Cliente', 'Admin', 'Propietario']),
                          optionLabels: const ['Cliente', 'Admin', 'Propietario'],
                          onChanged: (val) =>
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.goNamedAuth('newLogin', context.mounted);
                          },
                          text: 'Log Out',
                          icon: const Icon(
                            Icons.output_sharp,
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await actions.createUser(
                              ...
                              _model.dDRolValue!,
                              _model.txtImagenTextController.text,
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: const Text('The user has been created'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
