...
class _BuscarProductosWidgetState extends State<BuscarProductosWidget> {
  ...
  void initState() {
    ...
    _model.txPrecioTextController ??= TextEditingController();
    _model.txPrecioFocusNode ??= FocusNode();
  }
            ...
            children: [
              PagedListView<DocumentSnapshot<Object?>?, ProductosRecord>(
                pagingController: _model.setListViewController(
                  ProductosRecord.collection.where(Filter.or(
                    Filter(
                      'nombre',
                      isEqualTo: _model.txtNombreTextController.text,
                    ),
                    Filter(
                      'precio',
                      isEqualTo:
                          int.tryParse(_model.txPrecioTextController.text),
                    ),
                  )),
                ),
                    ...
                    Expanded(
                      child: Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 0.0),
                        child: TextFormField(
                          controller: _model.txPrecioTextController,
                          focusNode: _model.txPrecioFocusNode,
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Precio',
                          ...
                          validator: _model.txPrecioTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    ...
                    StreamBuilder<List<ProductosRecord>>(
                      stream: queryProductosRecord(
                        queryBuilder: (productosRecord) =>
                            productosRecord.where(Filter.or(
                          Filter(
                            'nombre',
                            isEqualTo: _model.txtNombreTextController.text,
                          ),
                          Filter(
                            ...
                            isEqualTo: int.tryParse(
                                _model.txPrecioTextController.text),
                          ),
                        )),
                        limit: 25,
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<ProductosRecord> buttonProductosRecordList =
                            snapshot.data!;
